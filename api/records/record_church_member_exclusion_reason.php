...
$stmt = $conn->prepare("SELECT exclusion_reason_id, reason FROM church_member_exclusion_reasons WHERE head_parish_id = ?");
...
$stmt = $conn->prepare("INSERT INTO church_member_exclusion_reasons (reason, head_parish_id, created_at) VALUES (?, ?, ?)");
