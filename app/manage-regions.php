...
<head>
  <?php 
    ...
    render_header('Manage Regions - Kanisa Langu');
  ?>
  <style>
    #loading {
...
<body>
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manage Regions</h5>
            <!-- Search Form -->
            <div class="row mb-4">
              <div class="col-md-8">
                <input type="text" id="searchRegion" class="form-control" placeholder="Search Region by Name">
              </div>
            ...
            <!-- Pagination -->
            <nav id="paginationNav" aria-label="Region pagination">
  ...
  <script>
    $(document).ready(function () {
        const fetchRegions = (page = 1, query = '') => {
            $('#loading').show(); // Show loading GIF
            $.ajax({
                type: 'GET',
                url: `/api/data/regions.php?page=${page}&query=${query}`,
                dataType: 'json',
        ...
        $('#searchBtn').on('click', function () {
            const query = $('#searchRegion').val();
            fetchRegions(1, query);
        });
