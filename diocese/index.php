...
$admin_id = $_SESSION['diocese_admin_id'];
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Welcome, <?php echo htmlspecialchars($_SESSION['diocese_admin_fullname']); ?>!</h5>
            ...
            <ul class="list-group">
              <li class="list-group-item"><strong>Full Name:</strong> <?php echo htmlspecialchars($_SESSION['diocese_admin_fullname']); ?></li>
              <li class="list-group-item"><strong>Email:</strong> <?php echo htmlspecialchars($_SESSION['diocese_admin_email']); ?></li>
              <li class="list-group-item"><strong>Phone:</strong> <?php echo htmlspecialchars($_SESSION['diocese_admin_phone']); ?></li>
              <li class="list-group-item"><strong>Diocese:</strong> <?php echo htmlspecialchars($_SESSION['diocese_name']); ?></li>
              <li class="list-group-item"><strong>Role:</strong> <?php echo htmlspecialchars($_SESSION['diocese_admin_role']); ?></li>
            </ul>
          </div>
        </div>
      </div>
