      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col-md-8">
                <input type="text" id="searchMember" class="form-control" placeholder="Search Members by First name, middle name, last name or envelope number">
              </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border" id="envelopeNumber" name="envelopeNumber" />
                            </div>
                            <div class="mb-3">
...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    $('#firstName, #middleName, #lastName, #phone, #envelopeNumber').prop('readonly', false);
                    $('#subParish, #community, #type').prop('readonly', true);
    ...
    $('#editMemberForm').on('submit', function (event) {
        ...
        $.ajax({
            type: 'POST',
            url: '../api/registration/update_church_member.php',
            data: formData,
            success: function (response) {
                if (response.success) {
                    ...
                    $('#messageContainer').html('<div class="response-message"><i class="fas fa-spinner fa-spin icon"></i> Updating details...</div>');
