    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      ...
      <!-- Events Section -->
        ...
        <li class="sidebar-item has-submenu">
          <a class="sidebar-link" href="#" aria-expanded="false">
            <span>
              <i class="ti ti-user-check"></i> <!-- Attendance-related icon -->
            </span>
        ...
        <li class="sidebar-item has-submenu">
          ...
          <ul class="submenu">
            ...
            <li><a href="/head-parish/record-bank-account-closing-balance">Record Closing Balances</a></li>
          </ul>
        </li>
        ...
        <li class="sidebar-item has-submenu">
            ...
            <ul class="submenu">
                ...
                <li><a href="/head-parish/harambee-record-statistics">Recorded Contributions</a></li>
