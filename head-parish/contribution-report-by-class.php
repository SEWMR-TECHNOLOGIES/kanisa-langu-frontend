...
<head>
  <?php 
    ...
    render_header('Harambee Community Report By Class - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Harambee Community Report By Class</h5>
                ...
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    ...
                    <div class="d-flex gap-2 mt-3">
                      <button type="submit" class="btn btn-secondary" data-action="download_head_parish_report">Get Report by Head Parish</button>
                      <button type="submit" class="btn btn-primary" data-action="download_community_report">Get Report by Community</button>
                    </div>
...
$(document).ready(function () {
    ...
    function submitForm(formId, target) {
        ...
        let url = '../api/data/download_harambee_report_by_class'; 
        const action = clickedButton.data('action');
        
        switch (action) {
            case 'download_head_parish_report':
                url = '../api/data/download_harambee_report_by_class_head_parish';
                break;
            case 'download_sub_parish_report':
                url = '../api/data/download_sub_parish_report';
                break;
            case 'download_community_report':
                url = '../api/data/download_harambee_report_by_class_community';
                break;
            case 'download_group_report':
                url = '../api/data/download_group_report';
                break;
            default:
