...
<head>
  <?php 
    ...
    render_header('Create System User - Kanisa Langu');
  ?>
</head>
...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Create System Users</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="mb-3">
                        ...
                        <?php renderAdminRoleSelectOptions('admin_role','adminRoleHP'); ?>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-6">
                      <div class="mb-3">
                        ...
                        <select class="form-select" id="adminRoleCom" name="admin_role">
                          ...
                          <option value="accountant">Accountant</option>
                          <option value="chairperson">Chairperson</option>
                          <option value="elder">Mzee wa Kanisa</option>
                        </select>
                      </div>
                    </div>
                  </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $('#responseMessage').html('<div class="response-message"><i class="fas fa-spinner fa-spin icon"></i> Creating Admin...</div>');
