...
<head>
  <?php 
    ...
    render_header('Create Revenue Groups - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Create Revenue Groups</h5>
              ...
              <div class="tab-content mt-3" id="harambeeTabContent">
                <!-- Head Parish Revenue Group Form -->
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameHP" class="form-label">Revenue Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameHP" name="revenue_group_name" placeholder="Revenue Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameSP" class="form-label">Revenue Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameSP" name="revenue_group_name" placeholder="Revenue Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameCOM" class="form-label">Revenue Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameCOM" name="revenue_group_name" placeholder="Revenue Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameGP" class="form-label">Revenue Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameGP" name="revenue_group_name" placeholder="Revenue Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/create_revenue_group',
        data: formData,
        dataType: 'json',
