...
<head>
  <?php 
    ...
    render_header('Generate Harambee Letters - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Generate Harambee Letters</h5>

            <!-- Guide for Users -->
            <div class="alert alert-info">
              <h6><strong>Excel File Format:</strong></h6>
              <ul>
                <li><strong>Column A:</strong> Church Member Name</li>
                <li><strong>Column B:</strong> Proposed Target Amount</li>
                <li><strong>Column C:</strong> Mr/Mrs (Yes if Mr & Mrs and No otherwise)</li>
              </ul>
              <p><strong>Note:</strong>Please ensure the Excel file follows this order for successful harambee letter generation.</p>
            </div>
            ...
            <form id="uploadEnvelopeDataForm" autocomplete="off" enctype="multipart/form-data">
              ...
              <!-- Submit Button -->
              <div class="mb-3">
                <button type="submit" class="btn btn-primary">Upload Harambee Data</button>
              </div>
            </form>
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            if (response.download_url) {
              messageHtml += `<br><a href="${response.download_url}" class="btn btn-secondary" download>Download Letters</a>`;
            }
