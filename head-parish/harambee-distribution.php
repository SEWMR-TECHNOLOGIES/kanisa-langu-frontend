...
<head>
  <?php 
    ...
    render_header('Harambee Distribution - Kanisa Langu');
  ?>
  <style>
    #loading {
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Harambee Distribution</h5>
...
$(document).ready(function () {
    ...
    const fetchHarambee = (target, page = 1, query = '') => {
        $('#loading').show();
        let url = `../api/data/harambee_distribution?target=${target}&page=${page}&query=${query}`;
        $.ajax({
            type: 'GET',
            url: url,
            dataType: 'json',
                    ...
                    case 'head-parish':
                        ...
                        harambeeList = response.data.map((harambee, index) => `
                            <tr>
                                ...
                                <td>${harambee.description} (From: ${harambee.from_date} To: ${harambee.to_date})</td>
                                <td>${harambee.sub_parish_name}</td>
                                <td>TZS ${harambee.amount}</td>
                                <td style="color: green;">${harambee.percentage.toFixed(2)}%</td>
                                <td class="text-end">
    ...
    // Initial fetch for Head Parish Harambee
