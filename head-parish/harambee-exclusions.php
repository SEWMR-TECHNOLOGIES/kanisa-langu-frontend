...
<head>
  <?php 
    ...
    render_header('Manage Harambee Exclusion Reasons - Kanisa Langu');
  ?>
  <style>
    #loading {
      display: none;
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manage Harambee Exclusion Reasons</h5>
    ...
    $(document).ready(function () {
     ...
     function showResponseMessage(message, isSuccess = true) {
      ...
      function fetchReasons(page = 1, query = '') {
        ...
        $.ajax({
          type: 'GET',
          url: `../api/data/harambee_exclusion_reasons.php?limit=${limit}&page=${page}&query=${encodeURIComponent(query)}`,
          dataType: 'json',
      ...
      $('#confirmDeleteBtn').on('click', function() {
        ...
        $.ajax({
          type: 'POST',
          url: '../api/delete/delete_harambee_exclusion_reason.php',
