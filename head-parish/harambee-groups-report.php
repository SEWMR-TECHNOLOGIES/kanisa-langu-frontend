...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Harambee Groups Report</h5>
              ...
              <div class="tab-content mt-3" id="harambeeTabContent">
                ...
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3" id="headParishGroupsTableBody">
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3" id="subParishGroupsTableBody">
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3" id="communityGroupsTableBody">
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3" id="groupGroupsTableBody">
...
<script>
  ...
  $(document).ready(function () {
    ...
    function showDownloadButton(targetId, target, harambeeId, subParishId = null) {
        // Get the current client date and time (timestamp)
        const clientTimestamp = getLocalTimestamp();
    
        // Create the base URL for downloading the group details with timestamp
        let downloadUrl = `../reports/harambee_groups_report.php?target=${target}&harambee_id=${harambeeId}&timestamp=${encodeURIComponent(clientTimestamp)}`;
    
        // Append the sub_parish_id if provided
        if (subParishId) {
            downloadUrl += `&sub_parish_id=${subParishId}`;
        }
    
        // Generate the button HTML
        const buttonHtml = `
            <div class="text-center mt-3">
                <a href="${downloadUrl}" class="btn btn-success btn-lg" target="_blank">
                    Download Harambee Group Statement
                </a>
            </div>`;
    
        // Populate the target container with the button
        $('#' + targetId).html(buttonHtml);
    }
    ...
    // Attach change event for Head Parish Harambee ID
      $('#harambeeIdHP, #subParishIdHP').change(function () {
        ...
        const harambeeId = $('#harambeeIdHP').val(); 
        const subParishId = $('#subParishIdHP').val(); // Get selected Sub Parish ID
        if (harambeeId && subParishId) { // Check if harambeeId is not empty
          showDownloadButton(targetId, target, harambeeId, subParishId);
        } else {
          $('#' + targetId).html('');
        }
      });
      ...
      $('#harambeeIdSP').change(function () {
        ...
        if (harambeeId) { // Check if harambeeId is not empty
          showDownloadButton(targetId, target, harambeeId);
        } else {
          $('#' + targetId).html('');
        }
      });
