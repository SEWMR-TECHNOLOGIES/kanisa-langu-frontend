...
// Call the function on any page that requires admin authentication
...
<head>
  <?php 
    ...
    render_header('Manage Head Parish Admins - Kanisa Langu');
  ?>
  <style>
    #loading {
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manage Head Parish Admins</h5>
            <!-- Search Form -->
            <div class="row mb-4">
              <div class="col-md-8">
                <input type="text" id="searchAdmin" class="form-control" placeholder="Search Admin by Name or Parish Name">
              </div>
...
<script>
    $(document).ready(function () {
        const fetchAdmins = (page = 1, query = '') => {
            ...
            $.ajax({
                type: 'GET',
                url: `../api/data/head_parish_admins?page=${page}&query=${query}`,
                dataType: 'json',
                success: function (response) {
                    ...
                    admins.forEach(admin => {
                        ...
                        const parishName = admin.parish_name ? admin.parish_name : 'Unknown Parish';
