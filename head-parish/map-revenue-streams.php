...
<head>
  <?php 
    ...
    render_header('Map Revenue Streams - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Map Revenue Streams With Revenue Groups</h5>
              ...
              <div class="tab-content mt-3" id="expenseNamesTabContent">
                <!-- Head Parish Revenue Name Form -->
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupHeadParish" class="form-label">Revenue Group</label>
                          <select class="form-select" id="expenseGroupHeadParish" name="revenue_group_id">
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupSubParish" class="form-label">Revenue Group</label>
                          <select class="form-select" id="expenseGroupSubParish" name="revenue_group_id">
                            <option value="">Select Revenue Group</option>
                            <!-- Options populated by AJAX -->
                          </select>
                        </div>
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupCommunity" class="form-label">Revenue Group</label>
                          <select class="form-select" id="expenseGroupCommunity" name="revenue_group_id">
                            <option value="">Select Revenue Group</option>
                            <!-- Options populated by AJAX -->
                          </select>
                        </div>
                ...
                <!-- Group Revenue Name Form -->
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupGroup" class="form-label">Revenue Group</label>
                          <select class="form-select" id="expenseGroupGroup" name="revenue_group_id">
                            <option value="">Select Revenue Group</option>
                            <!-- Options populated by AJAX -->
                          </select>
                        </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/record_revenue_group_map',
        data: formData,
        dataType: 'json',
    ...
    // Function to load revenue groups with a target parameter
    function loadExpenseGroups(target) {
        $.ajax({
            type: 'GET',
            url: '../api/data/revenue_groups?limit=all&target=' + target,
            dataType: 'json',
            success: function (response) {
                ...
                $.each(response.data, function (index, group) {
                    ...
                    let displayName = group.revenue_group_name;
                    ...
                    options += '<option value="' + group.revenue_group_id + '">' + displayName + '</option>';
                });
