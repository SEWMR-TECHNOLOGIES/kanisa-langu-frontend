...
<head>
  <?php 
    ...
    render_header('On Going Budget Position - Kanisa Langu');
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">On Going Budget Position (OGO)</h5>
                  ...
                  <form id="headParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="yearSelectHP" class="form-label">Select Year</label>
                                <select class="form-control" id="yearSelectHP" name="year">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="reportOrderHP" class="form-label">Select Report Order</label>
                                <select class="form-control" id="reportOrderHP" name="report_order">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="orderColumnHP" class="form-label">Select Ordering Column</label>
                                <select class="form-control" id="orderColumnHP" name="order_column">
                                    <option value="expense_identifier">Expense Name</option>
                                    <option value="expense_budget">Expense Budget</option>
                                    <option value="total_expense_amount">Total Expense Amount</option>
                                    <option value="annual_budget_balance">Annual Budget Balance</option>
                                    <option value="expenditure_percentage">Expenditure Percentage</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary">View OGO</button>
                  </form>
                </div>
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="reportOrderSP" class="form-label">Select Report Order</label>
                                <select class="form-control" id="reportOrderSP" name="report_order">
                                    <option value="default">Default</option>
                                    <option value="ascending">Ascending</option>
                                    <option value="descending">Descending</option>
                                </select>
                    ...
                    <div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="orderColumnSP" class="form-label">Select Ordering Column</label>
                                <select class="form-control" id="orderColumnSP" name="order_column">
                                    <option value="expense_identifier">Expense Name</option>
                                    <option value="expense_budget">Expense Budget</option>
                                    <option value="total_expense_amount">Total Expense Amount</option>
                                    <option value="annual_budget_balance">Annual Budget Balance</option>
                  ...
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="yearSelectCOM" class="form-label">Select Year</label>
                                <select class="form-control" id="yearSelectCOM" name="year">
                                    <option value="">Select Budget Year</option>
                                    <?php
                                    for ($year = 2024; $year <= $currentYear; $year++) {
                                        echo "<option value=\"$year\">$year</option>";
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="reportOrderCOM" class="form-label">Select Report Order</label>
                                <select class="form-control" id="reportOrderCOM" name="report_order">
                                    <option value="default">Default</option>
                                    <option value="ascending">Ascending</option>
                                    <option value="descending">Descending</option>
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="orderColumnGP" class="form-label">Select Ordering Column</label>
                                <select class="form-control" id="orderColumnGP" name="order_column">
                                    <option value="expense_identifier">Expense Name</option>
                                    <option value="expense_budget">Expense Budget</option>
                                    <option value="total_expense_amount">Total Expense Amount</option>
                                    <option value="annual_budget_balance">Annual Budget Balance</option>
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="yearSelectGP" class="form-label">Select Year</label>
                                <select class="form-control" id="yearSelectGP" name="year">
                                    <option value="">Select Budget Year</option>
                                    <?php
                                    for ($year = 2024; $year <= $currentYear; $year++) {
                                        echo "<option value=\"$year\">$year</option>";
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="reportOrderGP" class="form-label">Select Report Order</label>
                                <select class="form-control" id="reportOrderGP" name="report_order">
                                    <option value="default">Default</option>
                                    <option value="ascending">Ascending</option>
                                    <option value="descending">Descending</option>
                                </select>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/data/generate_ogo_report',
        data: formData,
        dataType: 'json',
        success: function (response) {
                ...
                if (response.success) {
                    ...
                    setTimeout(function () {
                        if (response.url) {
                            const updatedUrl = response.url + '&client_datetime=' + encodeURIComponent(formattedDateTime);
                            window.open(updatedUrl, '_blank'); // Open the URL in a new tab
                        } else {
