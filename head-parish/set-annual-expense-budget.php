...
<head>
  <?php 
    ...
    render_header('Set Annual Expense Budget - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Set Annual Expense Budget</h5>

              <ul class="nav nav-tabs" id="expenseBudgetTabs" role="tablist">
                ...
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseBudgetHP" class="form-label">Expense Budget Amount</label>
                          <input type="number" class="form-control" id="expenseBudgetHP" name="expense_budget_target_amount" placeholder="Expense Budget" min="0">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary">Set Expense Budget</button>
                  </form>
                </div>
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseBudgetSP" class="form-label">Expense Budget Amount</label>
                          <input type="number" class="form-control" id="expenseBudgetSP" name="expense_budget_target_amount" placeholder="Expense Budget" min="0">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseBudgetCOM" class="form-label">Expense Budget Amount</label>
                          <input type="number" class="form-control" id="expenseBudgetCOM" name="expense_budget_target_amount" placeholder="Expense Budget" min="0">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseBudgetGP" class="form-label">Expense Budget Amount</label>
                          <input type="number" class="form-control" id="expenseBudgetGP" name="expense_budget_target_amount" placeholder="Expense Budget" min="0">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/set_annual_expense_budget',
        data: formData,
        dataType: 'json',
