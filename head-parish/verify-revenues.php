...
<head>
  <?php 
    ...
    render_header('Verify Revenues - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Verify Collected Revenues</h5>
            ...
            <div class="tab-content mt-3" id="revenueTabContent">
              ...
              <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                <form id="headParishForm">
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Verify Head Parish Revenues</button>
                  </div>
                </form>
              </div>
              ...
              <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                <form id="subParishForm">
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Verify Sub Parish Revenues</button>
                  </div>
                </form>
              </div>
              ...
              <div class="tab-pane fade" id="community" role="tabpanel">
                <form id="communityForm">
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Verify Community Revenues</button>
                  </div>
                </form>
              </div>
              ...
              <div class="tab-pane fade" id="group" role="tabpanel">
                <form id="groupForm">
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Verify Group Revenues</button>
                  </div>
                </form>
              </div>
            </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $('#responseMessage').html('<div class="loading">Verifying revenues...</div>');
      $.ajax({
        type: 'POST',
        url: '../api/data/verify_revenues',
        data: formData,
        dataType: 'json',
