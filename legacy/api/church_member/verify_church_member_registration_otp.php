...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $otp_query = "SELECT member_id, status, TIMESTAMPDIFF(MINUTE, created_at, NOW()) AS otp_age 
                  FROM church_member_registration_tokens 
                  WHERE registration_token = ? AND status = 'unused'";
    ...
    $update_otp_query = "UPDATE church_member_registration_tokens SET status = 'used' WHERE registration_token = ?";
