...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(in_array($target, ALLOWED_TARGETS)){
       $report_url = "https://www.kanisalangu.sewmrtechnologies.com/reports/harambee_contribution_report_by_class_head_parish.php?harambee_id=$encrypted_harambee_id&target=$target"; 
    }else{
