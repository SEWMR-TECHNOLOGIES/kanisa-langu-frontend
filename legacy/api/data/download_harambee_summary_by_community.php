...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($target) {
        case 'head-parish':
            ...
            $report_url = "https://www.kanisalangu.sewmrtechnologies.com/reports/harambee_contribution_summary_by_community.php?harambee_id=$encrypted_harambee_id&target=head-parish&sub_parish_id=$encrypted_sub_parish_id&community_id=$encrypted_community_id&from_date=$from_date&to_date=$to_date&group_by_communities=$group_by_communities";
            break;
        ...
        case 'sub-parish':
            ...
            $encrypted_sub_parish_id = encryptData($sub_parish_id);  // Encrypt the sub_parish_id
            $report_url = "https://www.kanisalangu.sewmrtechnologies.com/reports/harambee_contribution_summary_by_community.php?harambee_id=$encrypted_harambee_id&target=sub-parish&sub_parish_id=$encrypted_sub_parish_id&from_date=$from_date&to_date=$to_date&group_by_communities=$group_by_communities";
            break;
        ...
        case 'community':
            ...
            $encrypted_sub_parish_id = encryptData($sub_parish_id);  // Encrypt the sub_parish_id
            $encrypted_community_id = encryptData($community_id);  // Encrypt the community_id
            $report_url = "https://www.kanisalangu.sewmrtechnologies.com/reports/harambee_contribution_summary_by_community.php?harambee_id=$encrypted_harambee_id&target=community&sub_parish_id=$encrypted_sub_parish_id&community_id=$encrypted_community_id&from_date=$from_date&to_date=$to_date&group_by_communities=$group_by_communities";
            break;
        ...
        case 'group':
            ...
            $report_url = "https://www.kanisalangu.sewmrtechnologies.com/reports/harambee_contribution_summary_by_community.php?harambee_id=$encrypted_harambee_id&target=group&group_id=$encrypted_group_id&from_date=$from_date&to_date=$to_date&group_by_communities=$group_by_communities";
            break;
