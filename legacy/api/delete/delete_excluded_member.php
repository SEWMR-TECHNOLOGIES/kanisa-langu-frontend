...
$stmt = $conn->prepare("SELECT exclusion_id FROM church_member_exclusions WHERE exclusion_id = ? AND head_parish_id = ?");
...
// Perform deletion
$stmt = $conn->prepare("DELETE FROM church_member_exclusions WHERE exclusion_id = ?");
