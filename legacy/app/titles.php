...
<head>
  <?php 
    ...
    render_header('Manage Titles - Kanisa Langu');
  ?>
  <style>
    #loading {
...
<body>
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manage Titles</h5>
            <!-- Search Form -->
            <div class="row mb-4">
              <div class="col-md-8">
                <input type="text" id="searchTitle" class="form-control" placeholder="Search Title by Name">
              </div>
            ...
            <!-- Pagination -->
            <nav id="paginationNav" aria-label="Title pagination">
  ...
  <script>
    $(document).ready(function () {
        const fetchTitles = (page = 1, query = '') => {
            $('#loading').show(); // Show loading GIF
            $.ajax({
                type: 'GET',
                url: `/api/data/titles.php?page=${page}&query=${query}`,
                dataType: 'json',
