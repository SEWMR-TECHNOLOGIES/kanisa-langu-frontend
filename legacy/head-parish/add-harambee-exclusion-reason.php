...
<head>
  <?php 
    ...
    render_header('Record Harambee Exclusion Reason - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Record Harambee Exclusion Reason</h5>
  ...
  <script>
    $(document).ready(function () {
      $('#exclusionReasonForm').on('submit', function (e) {
        ...
        $.ajax({
          type: 'POST',
          url: '/api/records/record_harambee_exclusion_reason.php',
          data: formData,
          dataType: 'json',
