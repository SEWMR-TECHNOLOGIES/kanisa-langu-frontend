...
<head>
  <?php 
    ...
    render_header('Harambee Contribution Summary - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Harambee Contribution Summary</h5>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" id="fromDateHP" name="from_date" value="<?php echo $monday; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="toDateHP" class="form-label">To Date</label>
                          <input type="date" class="form-control" id="toDateHP" name="to_date" value="<?php echo $sunday; ?>" max="<?php echo $sunday; ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Group By Communities Checkbox -->
                    <div class="row mb-2">
                      <div class="col-lg-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="groupByCommunitiesHP" name="group_by_communities" value="true">
                          <label class="form-check-label" for="groupByCommunitiesHP">Group By Communities</label>
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-secondary" data-action="by_head_parish">Download By Head Parish</button>
                    <button type="submit" class="btn btn-primary" data-action="by_sub_parish">Download By Sub Parish</button>
                    <button type="submit" class="btn btn-danger" data-action="by_community">Download By Community</button>
                  </form>
                </div>
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" id="fromDateSP" name="from_date" value="<?php echo $monday; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="toDateSP" class="form-label">To Date</label>
                          <input type="date" class="form-control" id="toDateSP"  name="to_date" value="<?php echo $sunday; ?>" max="<?php echo $sunday; ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Group By Communities Checkbox -->
                    <div class="row mb-2">
                      <div class="col-lg-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="groupByCommunitiesSP" name="group_by_communities" value="true">
                          <label class="form-check-label" for="groupByCommunitiesSP">Group By Communities</label>
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-secondary" data-action="by_head_parish">Download By Head Parish</button>
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" id="fromDateCom" name="from_date" value="<?php echo $monday; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="toDateCom" class="form-label">To Date</label>
                          <input type="date" class="form-control" id="toDateCom"  name="to_date" value="<?php echo $sunday; ?>" max="<?php echo $sunday; ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Group By Communities Checkbox -->
                    <div class="row mb-2">
                      <div class="col-lg-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="groupByCommunitiesCom" name="group_by_communities" value="true">
                          <label class="form-check-label" for="groupByCommunitiesCom">Group By Communities</label>
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-secondary" data-action="by_head_parish">Download By Head Parish</button>
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" id="fromDateGroup" name="from_date" value="<?php echo $monday; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="toDateGroup" class="form-label">To Date</label>
                          <input type="date" class="form-control" id="toDateGroup"  name="to_date" value="<?php echo $sunday; ?>" max="<?php echo $sunday; ?>">
                        </div>
                      </div>
                    </div>
                     <!-- Group By Communities Checkbox -->
                    <div class="row mb-2">
                      <div class="col-lg-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="groupByCommunitiesGP" name="group_by_communities" value="true">
                          <label class="form-check-label" for="groupByCommunitiesGP">Group By Communities</label>
                        </div>
                      </div>
                    </div>
...
$(document).ready(function () {
    ...
    function submitForm(formId, target) {
        ...
        const $form = $(formId);
        const clickedButton = $form.find('button[type="submit"][data-action]:focus');
        // Determine URL from data-action
        let url = '../api/data/download_harambee_summary'; 
        const action = clickedButton.data('action');
        
        switch (action) {
            case 'by_head_parish':
                url = '../api/data/download_harambee_summary_by_head_parish';
                break;
            case 'by_sub_parish':
                url = '../api/data/download_harambee_summary_by_sub_parish';
                break;
            case 'by_community':
                url = '../api/data/download_harambee_summary_by_community';
                break;
            default:
                console.warn('Unknown or missing data-action, using default URL.');
        }
  ...
  function loadHarambee(targetId, url) {
    ...
    $('#subParishIdCom, #subParishIdHP').on('change', function () {
