            ...
            <form id="harambeeContributionForm" autocomplete="off">
              ...
              <div class="row">
                <div class="mb-3">
                  ...
                  <?php if ($currentAdminRole !== 'clerk'): ?>
                    <button type="button" id="downloadAllClerksReport" class="btn btn-success mb-2">
                      Download Report for All Clerks
                    </button>
                
                    <button type="button" id="downloadAllClerksDetailedReport" class="btn btn-warning mb-2">
                      Download Detailed Report for All Clerks
                    </button>
                  <?php endif; ?>
                </div>
              </div>
