...
<head>
  <?php 
    ...
    render_header('Manage Payment Gateway Wallets - Kanisa Langu');
  ?>
  <style>
    #loading {
...
<body>
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Manage Payment Gateway Wallets</h5>

            <!-- Search Form -->
            <div class="row mb-4">
              <div class="col-md-8">
                <input type="text" id="searchWallet" class="form-control" placeholder="Search by Merchant Code or Client ID">
              </div>
            ...
            <!-- Pagination -->
            <nav id="paginationNav" aria-label="Payment Gateway Wallets pagination">
  ...
  <script>
    $(document).ready(function () {
        const fetchWallets = (page = 1, query = '') => {
            $('#loading').show(); // Show loading GIF
            $.ajax({
                type: 'GET',
                url: `../api/data/head_parish_payment_gateway_wallets?page=${page}&query=${query}`, 
                dataType: 'json',
        ...
        $('#searchBtn').on('click', function () {
            const query = $('#searchWallet').val();
            fetchWallets(1, query);
        });

        // Attach onchange event to search input
        $('#searchWallet').on('input', function () {
