              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone (0XXXXXXXXX)">
                  </div>
                </div>
    ...
    $.ajax({
      ...
      success: function (response) {
          ...
          if (response.success) {
            ...
            setTimeout(function () {
              // Redirect based on returnUrl if present
              if (returnUrl) {
                window.location.href = decodeURIComponent(returnUrl);
              } else {
                window.location.href = './register-church-member'; // default fallback
              }
            }, 2000);
