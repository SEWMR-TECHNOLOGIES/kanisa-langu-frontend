...
<head>
  <?php 
    ...
    render_header('Send Harambee Summary SMS - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Send Harambee Summary SMS</h5>
            ...
            <div class="mb-3 d-flex flex-column flex-md-row">
              <button type="submit" class="btn btn-primary mb-2 mb-md-0 w-100 w-md-auto">Send Summary SMS</button>
            </div>
            </form>
          </div>
        </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#harambeeContributionForm').submit(function (event) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/send_harambee_summary_sms',
        data: formData,
        dataType: 'json',
        success: function (response) {
          let messageHtml = '';
