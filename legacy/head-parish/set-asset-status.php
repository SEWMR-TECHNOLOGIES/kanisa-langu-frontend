...
<head>
  <?php 
    ...
    render_header('Record Asset Status - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Record Asset Status</h5>

            <!-- Asset Status Form -->
            <form id="assetStatusForm" autocomplete="off">
              <div class="row">
                <div class="col-lg-6">
                  <div class="mb-3">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="statusDate" name="status_date" 
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <select class="form-select" id="status" name="status">
                      ...
                      <option value="Sio Nzuri">Sio Nzuri</option>
                    </select>
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="mb-3">
                <button type="submit" class="btn btn-primary">Record Asset Status</button>
              </div>
            </form>
...
<script>
  ...
  $(document).ready(function () {
    ...
    function loadAssets() {
      $.ajax({
        type: 'GET',
        url: '../api/data/head_parish_assets?limit=all', 
        dataType: 'json',
    ...
    // Submit asset status form
    $('#assetStatusForm').submit(function (event) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/record_asset_status',
        data: formData,
        dataType: 'json',
        success: function (response) {
          let messageHtml = '';
          if (response.success) {
            ...
            setTimeout(function () {
              ...
              $('#description').val('');
              $('#statusDate').val('<?php echo date('Y-m-d'); ?>'); // Reset to today’s date
