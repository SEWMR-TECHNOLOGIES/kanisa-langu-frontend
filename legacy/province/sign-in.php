...
<head>
  <?php 
    ...
    render_header('Province Admin Login - Kanisa Langu');
  ?>
...
<script>
  $(document).ready(function () {
    $('#loginForm').on('submit', function (event) {
      ...
      $.ajax({
        type: 'POST',
        url: '/api/province_admin_signin.php', 
        data: {
          email_phone: username,
          password: password,
          recaptcha_response: recaptchaResponse, // This name should match PHP
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            grecaptcha.reset(); // Reset the reCAPTCHA on failure
          }
