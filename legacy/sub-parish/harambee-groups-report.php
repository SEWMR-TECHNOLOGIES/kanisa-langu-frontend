...
<script>
  ...
  $(document).ready(function () {
    ...
    function showDownloadButton(targetId, target, harambeeId) {
      ...
      const downloadUrl = `../reports/harambee_groups_report.php?target=${target}&harambee_id=${harambeeId}&timestamp=${encodeURIComponent(clientTimestamp)}`;
