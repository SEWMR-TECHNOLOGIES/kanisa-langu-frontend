                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionHP" name="description" rows="2" placeholder="Enter description..."></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionSP" name="description" rows="2" placeholder="Enter description..."></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionComm" name="description" rows="2" placeholder="Enter description..."></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionGroup" name="description" rows="2" placeholder="Enter description..."></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
