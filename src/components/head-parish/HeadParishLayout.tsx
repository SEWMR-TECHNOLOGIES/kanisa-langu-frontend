  ...
  return (
    <div className="min-h-screen bg-admin-bg">
      ...
      <div className="lg:ml-[280px] min-h-screen flex flex-col">
        {/* Header */}
        <header className="sticky top-0 z-30 bg-admin-header/80 backdrop-blur-xl border-b border-admin-border/50">
          <div className="flex items-center justify-between px-4 lg:px-8 h-16">
            <div className="flex items-center gap-4">
              <button
                onClick={() => setSidebarOpen(true)}
                className="lg:hidden p-2 rounded-lg hover:bg-admin-surface-hover text-admin-text"
              >
            ...
            <div className="flex items-center gap-3">
              {/* Search */}
              <div className="hidden md:flex items-center gap-2 px-3 py-2 rounded-xl bg-admin-surface border border-admin-border/50 w-64">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-admin-accent to-amber-600 flex items-center justify-center cursor-pointer">
                <span className="text-xs font-bold text-admin-bg">A</span>
              </div>
            </div>
          </div>
        </header>
