    ...
    <section id="cta" className="py-28">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary via-primary to-primary/80 px-8 sm:px-16 py-16 sm:py-20 text-center"
        >
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            <span className="inline-block text-sm font-semibold text-primary-foreground/70 uppercase tracking-widest mb-4">
              Download Now
            </span>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-primary-foreground tracking-tight leading-tight max-w-3xl mx-auto">
              Start Managing Your Church{" "}
              <span className="font-serif italic text-secondary">Today</span>
            </h2>
            <p className="mt-5 text-lg text-primary-foreground/70 max-w-lg mx-auto">
              Download Kanisa Langu for free and join hundreds of churches already simplifying their operations.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <a
                ...
                className="flex items-center gap-3 px-6 py-3.5 bg-white/10 hover:bg-white/20 rounded-2xl transition-colors border border-white/10"
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] text-primary-foreground/60 leading-none">Get it on</div>
                  <div className="text-base font-bold text-primary-foreground leading-tight">Google Play</div>
                </div>
              </a>
