...
const denominations = [
  ...
  { slug: "roman-catholic", name: "Catholic", icon: rcIcon, color: "border-red-500/20 hover:border-red-400/40" },
    ...
    <section className="relative min-h-screen flex items-center bg-[hsl(220,30%,6%)] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 pt-32 pb-24">
        ...
        >
          Manage your church
          <br />
          with <span className="text-secondary">clarity</span>
        </motion.h1>
            ...
            >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className="text-sm font-bold text-white/80 block">{d.name}</span>
        ...
        <motion.div
          ...
          className="flex gap-10 mt-14 pt-10 border-t border-white/[0.05]"
        >
          {[
