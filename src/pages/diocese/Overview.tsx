...
export default function DioceseOverview() {
  const revenueData = [
    { name: "Northern", amount: 200, pct: 82 },
    { name: "Eastern", amount: 150, pct: 65 },
    { name: "Southern", amount: 280, pct: 90 },
    { name: "Western", amount: 120, pct: 55 },
    { name: "Central", amount: 180, pct: 72 },
    { name: "Lake", amount: 220, pct: 78 },
  ];
  const memberData = [
    { name: "Northern", count: 12450, pct: 75 },
    { name: "Eastern", count: 8900, pct: 55 },
    { name: "Southern", count: 15200, pct: 92 },
    { name: "Western", count: 6700, pct: 42 },
    { name: "Central", count: 9800, pct: 60 },
    { name: "Lake", count: 11300, pct: 70 },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <StatsCard title="Provinces" value="6" change="All active" icon={Building2} color="info" delay={0} />
          ...
          <div className="space-y-4">
            {revenueData.map((p, i) => (
              <div key={p.name} className="flex items-center gap-4">
                <span className="text-xs text-admin-text w-20">{p.name}</span>
