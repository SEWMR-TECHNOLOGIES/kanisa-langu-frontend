...
<head>
  <?php 
    ...
    render_header('Create Expense Groups - Kanisa Langu');
  ?>
</head>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Create Expense Groups</h5>
                ...
                <div class="tab-pane fade show active" id="head-parish" role="tabpanel">
                  <form id="headParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameHP" class="form-label">Expense Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameHP" name="expense_group_name" placeholder="Expense Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="sub-parish" role="tabpanel">
                  <form id="subParishForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameSP" class="form-label">Expense Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameSP" name="expense_group_name" placeholder="Expense Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="community" role="tabpanel">
                  <form id="communityForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameCOM" class="form-label">Expense Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameCOM" name="expense_group_name" placeholder="Expense Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="group" role="tabpanel">
                  <form id="groupForm" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label for="expenseGroupNameGP" class="form-label">Expense Group Name</label>
                          <input type="text" class="form-control" id="expenseGroupNameGP" name="expense_group_name" placeholder="Expense Group Name">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-3">
...
<script>
  ...
  $(document).ready(function () {
    ...
    function submitForm(formId, target) {
      ...
      $.ajax({
        type: 'POST',
        url: '../api/records/create_expense_group',
        data: formData,
        dataType: 'json',
